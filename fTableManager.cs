using QuanLyQuanCafe_QLDA.DAO;
using QuanLyQuanCafe_QLDA.DTO;
using System;
...
namespace QuanLyQuanCafe_QLDA
{
    public partial class fTableManager : Form
    {
        ...
        {
            lsvBill.Items.Clear();
            List < QuanLyQuanCafe_QLDA.DTO.Menu> listBillInfo = MenuDAO.Instance.GetListMenuByTable(id);
            float totalPrice = 0;
            foreach (QuanLyQuanCafe_QLDA.DTO.Menu item in listBillInfo)
            {
        ...
        {
            btnAddFood_Click_1(this, new EventArgs());
        }
